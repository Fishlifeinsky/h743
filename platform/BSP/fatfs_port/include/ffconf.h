...
#define FF_STRF_ENCODE	3   // UTF-8 (与 FF_LFN_UNICODE=2 一致)
...
/  437 = U.S. English (SFN short name encoding; LFN uses UTF-8 via FF_LFN_UNICODE)
*/
...
/  1 = BSS 静态缓冲区, 最大 255 UTF-16 码点, 占用 ~512B RAM
/  需要 ffunicode.c 参与编译 (已在 3rd/fatfs/CMakeLists.txt 中)
/  注意: 非线程安全 (无 RTOS) */


#define FF_LFN_UNICODE	2
/* LFN API 字符编码: 2 = UTF-8 (TCHAR = char)
/  路径和文件名使用 UTF-8 编码, 与 printf/DEBUG_PRINT 兼容 */
